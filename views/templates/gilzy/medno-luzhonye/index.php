...
<table id="<?php echo $this->view; ?>" class="tl-fixed table table-dark table-striped table-bordered table-sm" style="border: 3px solid #000;">
    <thead>
      <tr>
        <th colspan="6" class="b-dark yellow title">МЕДНО-ЛУЖЕНЫЕ</th>
      </tr>
    <tr>
...
<?php foreach ($this->data as $key => $value): ?>
    <tr id="<?php echo $value['id'];?>">
      <td field="param0" class="b-red option"><?= floatval($value['param0']); ?></td>
      <td field="param1" class="b-green option"><?= $value['param1'] ?></td>
      <td field="param2" class="b-yellow name"><?= $value['param2'] ?></td>
      <td field="param4" class="b-purpur name"><?= $value['param4'] ?></td>
