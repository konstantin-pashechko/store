...
<table id="<?php echo $this->view ?>" class="table table-dark table-striped table-bordered table-sm">
  <thead>
    <tr>
      <th class="title white">Мощность, Вт</th>
      <th class="title white">Спектр, К</th>
      <th colspan="3" class="title white">MAXUS</th>
      <th colspan="3" class="title white">VIDEX</th>
      <th colspan="3" class="title white">GLOBAL</th>
      <th colspan="3" class="title white">LEBRON</th>
    </tr>
  </thead>
  <tbody>

    <?php foreach ($this->data as $key => $value): ?>
      <?php if ($value['param1'] == 0 && $_SESSION['edit'] == false){ continue; } ?>
