...
<div class="box0">
  <table id="<?= $this->view; ?>_tab1" class="tl-fixed table table-dark table-striped table-bordered table-sm">
    <thead>
      <tr>
        <th colspan="19" class="b-dark title">Р О З Е Т К И &nbsp; В С Т Р А И В А Е М Ы Е</th>
      </tr>
      <tr class="bordered">
    ...
    <tbody>
      <?php foreach ($this->data['tab1'] as $key => $value): ?>
        <tr id="<?php echo $value['id'];?>"<?php if(80 == $this->data['tab1'][$key+1]['_order']){echo 'class="bordered"';} ?>>
          ...
          <?php if($_SESSION['edit']): ?>
            <td field="_order"><?= $value['_order'] ?></td>
          <?php endif; ?>
...
<div class="box0">
  <table id="<?= $this->view; ?>_tab3" class="tl-fixed table table-dark table-striped table-bordered table-sm">
    <thead>
      <tr>
        <th colspan="19" class="b-dark title">Р А М К И</th>
      </tr>
      <tr class="bordered">
        <th colspan="3" class="b-yellow black title">Т И П</th>
        <th colspan="4" class="b-green black title">VIKO</th>
    ...
    <tbody>
      <?php foreach ($this->data['tab3'] as $key => $value): ?>
        <tr id="<?php echo $value['id'];?>"<?php if($value['param1'] !== $this->data['tab3'][$key+1]['param1']){echo 'class="bordered"';} ?>>
          <td colspan="3" field="param2" class="b-yellow option"><?php echo $value['param2'] ?></td>
